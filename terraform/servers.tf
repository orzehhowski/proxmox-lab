...
resource "proxmox_lxc" "LAB-S05-Data" {
  vmid        = 107
  target_node = var.node
  hostname = "LAB-S05-Data"
  ostemplate = "local:vztmpl/ubuntu-20.04-standard_20.04-1_amd64.tar.gz"
  ostype = "ubuntu"
  password = var.recovery_password
  ssh_public_keys = var.ssh_public_key
...
resource "proxmox_vm_qemu" "LAB-S12-Apps-HA" {
  name        = "LAB-S12-Apps-HA"
  target_node = var.node
  ...
  ipconfig0 = "ip=10.120.69.30/28,gw=10.120.69.17"
